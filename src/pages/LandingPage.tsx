...
import { Mail, Zap, Target, DollarSign, Search, Briefcase, UserCheck, Phone, Building, User } from 'lucide-react';
                ...
                <div className="max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:px-8">
                    <AnimatedSection className="text-center">
                        ...
                        <p className="mt-6 max-w-2xl mx-auto text-lg md:text-xl text-gray-600">
                            Join India's leading bidding platform and get exclusive access to thousands of daily loads. Fill your trucks, optimize your routes, and boost your revenue—effortlessly.
                        </p>
                        <div className="mt-8 flex justify-center gap-4">
                            <a href="#contact-us" className="inline-block px-8 py-3 bg-blue-600 text-white text-base font-semibold rounded-lg shadow-lg hover:bg-blue-700 transform hover:scale-105 transition-all duration-300">
                                Contact Us
                            </a>
                        </div>
                    </AnimatedSection>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <AnimatedSection className="text-center">
                        ...
                        <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
                            Our streamlined process is designed for speed and efficiency, connecting your fleet to critical loads faster than ever before.
                        </p>
                    </AnimatedSection>
             ...
             <section className="py-20 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <AnimatedSection className="text-center">
                        ...
                        <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
                            We provide the tools and opportunities to elevate your operations to the next level of profitability and efficiency.
                        </p>
                    </AnimatedSection>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="text-left">
                                ...
                                <p className="mt-4 text-lg text-gray-600">
                                    Have a question or need more information? Our partnership team is ready to assist you. Reach out to us directly or use the form to send us a message.
                                </p>
                                <div className="mt-8 space-y-4">
                                    <a href="mailto:partners@example.com" className="flex items-center text-lg text-gray-700 hover:text-blue-600 transition">
                                ...
                                <form className="space-y-6">
                                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-6'>
                                        <div>
                                            ...
                                            <input type="text" id="name" placeholder="Full Name" className="w-full p-4 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none transition" />
                                        </div>
                                        <div>
                                            <label htmlFor="company" className="sr-only">Company Name</label>
                                            <input type="text" id="company" placeholder="Company Name" className="w-full p-4 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none transition" />
                                        </div>
                                    </div>
                                    <div>
                                        <label htmlFor="email" className="sr-only">Business Email</label>
                                        <input type="email" id="email" placeholder="Business Email Address" className="w-full p-4 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none transition" />
                                    </div>
                                    <div>
                                        <label htmlFor="message" className="sr-only">Message</label>
                                        <textarea id="message" rows={4} placeholder="Your message or question..." className="w-full p-4 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none transition"></textarea>
                                    </div>
                                    <div>
                                        <button type="submit" className="w-full py-4 bg-blue-600 text-white text-lg font-semibold rounded-lg shadow-md hover:bg-blue-700 transform hover:scale-102 transition-all duration-300">
                                            Send Message
                                        </button>
                                    </div>
                                </form>
